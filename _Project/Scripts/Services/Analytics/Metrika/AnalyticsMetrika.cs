...
namespace _Project
{
    public class AnalyticsMetrika : IAnalytics
    {
        private const int CounterId = 95532082;
        ...
        public AnalyticsMetrika(IObjectResolver container)
        {
        ...
        public void LogEvent(string name, params (string Key, object Value)[] parameters)
        {
            ...
            Yandex.SDK.YandexMetricaSendInternal(CounterId, name, parametersDict.ToJson());
        }
