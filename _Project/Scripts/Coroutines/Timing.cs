...
// /////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static class MECExtensionMethods2
    {
        ...
        {
            while (Timing.MainThread != System.Threading.Thread.CurrentThread ||
        ...
        public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, System.Func<bool> condition)
        {
            ...
            while (Timing.MainThread != System.Threading.Thread.CurrentThread || (condition() && coroutine.MoveNext()))
                yield return coroutine.Current;
        }
        ...
        {
            while (Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject)
            {
        ...
        {
            while (Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject1 && gameObject2)
            {
        ...
        public static IEnumerator<float> PauseWith<T>(this IEnumerator<float> coroutine, T script) where T : MonoBehaviour
        {
            ...
            while (Timing.MainThread == System.Threading.Thread.CurrentThread && myGO && myGO.GetComponent<T>() != null)
            {
