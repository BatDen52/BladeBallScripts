...
namespace _Project.Data.Static.Skills
{
    ...
    [CreateAssetMenu(menuName = "Skills/ThunderDashSkill")]
    public class ThunderDashSkill : Skill
    {
        [field: SerializeField] public float Force { get; private set; }
        [field: SerializeField] public GameObject ThunderEffect { get; private set; }
        ...
        public override bool Activate(MonoBehaviour target)
        {
            ...
            _character.StateMachine.Enter<ThunderDashCharacterState>();
